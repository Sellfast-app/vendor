...
const RatingChart: React.FC<React.SVGProps<SVGElement>> = () => (
  <svg
  ...
  >
    ...
    ></path>
    <path
      fill="url(#paint0_linear_178_165998)"
    ...
    <defs>
      ...
      >
        <stop stopColor="#E8007C" stopOpacity="0.19"></stop>
        <stop offset="0.999" stopColor="#E8007C" stopOpacity="0.01"></stop>
      </linearGradient>
    </defs>
  </svg>
);
