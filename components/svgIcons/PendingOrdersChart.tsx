...
const PendingOrdersChart: React.FC<React.SVGProps<SVGElement>> = () => (
  <svg
  ...
  >
    ...
    ></path>
    <path
      fill="url(#paint0_linear_178_165972)"
    ...
    <defs>
      ...
      >
        <stop stopColor="#E6B800" stopOpacity="0.19"></stop>
        <stop offset="0.999" stopColor="#E6B800" stopOpacity="0.01"></stop>
      </linearGradient>
    </defs>
  </svg>
);
