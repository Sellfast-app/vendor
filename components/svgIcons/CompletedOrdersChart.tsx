...
const CompletedOrdersChart: React.FC<React.SVGProps<SVGElement>> = () => (
  <svg
  ...
  >
    ...
    ></path>
    <path
      fill="url(#paint0_linear_178_165985)"
    ...
    <defs>
      ...
      >
        <stop stopColor="#00D9A7" stopOpacity="0.19"></stop>
        <stop offset="0.999" stopColor="#00D9A7" stopOpacity="0.01"></stop>
      </linearGradient>
    </defs>
  </svg>
);
