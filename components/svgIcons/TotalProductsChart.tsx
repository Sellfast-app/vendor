...
const TotalProductsChart: React.FC<React.SVGProps<SVGElement>> = () => (
  <svg
  ...
  >
    ...
    ></path>
    <path
      fill="url(#paint0_linear_178_165892)"
    ...
    <defs>
      ...
      >
        <stop stopColor="#AF9CED" stopOpacity="0.19"></stop>
        <stop offset="0.999" stopColor="#AF9CED" stopOpacity="0.01"></stop>
      </linearGradient>
    </defs>
  </svg>
);
