...
const TotalOrdersChart: React.FC<React.SVGProps<SVGElement>> = () => (
  <svg
  ...
  >
    ...
    ></path>
    <path
      fill="url(#paint0_linear_178_165922)"
    ...
    <defs>
      ...
      >
        <stop stopColor="#FF8F2E" stopOpacity="0.19"></stop>
        <stop offset="0.999" stopColor="#FF8F2E" stopOpacity="0.01"></stop>
      </linearGradient>
    </defs>
  </svg>
);
