...
export function OverviewMetric({ metric }: MetricCardProps) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                // Use the new stores overview endpoint - no date range needed
                ...
                switch (metric.id) {
                    case "total-products":
                        ...
                        changePercent = 0; // Not provided in this endpoint
                        break;
                    ...
                    // Additional metrics you might want to use
                    case "total-sales":
                        currentValue = data.total_sales || 0;
                        changePercent = parseFloat(data.total_sales_percent_from_last_month || "0");
                        break;
                    
                    case "cancelled-orders":
                        currentValue = data.cancelled_orders || 0;
                        changePercent = 0; // Not provided in this endpoint
                        break;
                    
                    case "pending-orders":
                        currentValue = data.pending_orders || 0;
                        changePercent = 0; // Not provided in this endpoint
                        break;
                    
                    case "completed-orders":
                        currentValue = data.completed_orders || 0;
                        changePercent = 0; // Not provided in this endpoint
                        break;
                    
                    case "out-of-stock":
                        currentValue = data.out_of_stock || 0;
                        changePercent = 0; // Not provided in this endpoint
                        break;

                    case "average-rating":
                        currentValue = data.average_rating || "0";
                        changePercent = 0; // Not provided in this endpoint
                        break;    
